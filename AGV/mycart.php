...
<?php $p = ProductData::getById($s["idproducto"]); ?>
<tr>
<td><?php echo $p->code; ?></td>
<td><?php echo $p->name; ?></td>
<td style="width:100px;">
<form id="p-<?=$s["product_id"];?>">
<input type="hidden" name="p_id" value="<?=$s["idproducto"];?>">
<input type="number" name="q" id="num-<?=$s["idproducto"];?>" value="<?php echo $s["q"]; ?>" class="form-control">
</form>
<script>
...
<td style="width:30px;"><a href="index.php<?php echo $p->id; ?>&href=carro" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i></a></td>
<?php
$total += $s["q"]*$p->price;
 endforeach; ?>
</tr>
